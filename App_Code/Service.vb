...
<WebService(Namespace:="http://yourcompany.local/")> _
...
Public Class Service
    ...
    Declare Function ZIPGENALIGNED Lib "\\yourcompany.local\taxware\toolkit\avpzip.dll" (ByRef InputParmPtr As InputZip, ByRef ComplCode As Long, ByVal OutputParmPtr As String) As Byte
    Declare Function ZIPOPEN Lib "\\yourcompany.local\taxware\toolkit\avpzip.dll" (ByVal Action As Integer) As Byte
